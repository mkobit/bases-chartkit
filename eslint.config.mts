...
export default tseslint.config(
  ...
  // Refactored Transformers (Strict)
  {
    files: [
      ...
      'src/charts/transformers/axis-labels.ts',
      'src/charts/transformers/base.ts',
      'src/charts/transformers/bases-values.ts',
      ...
      'src/charts/transformers/dates.ts',
      ...
      'src/charts/transformers/legend.ts',
      ...
      'src/charts/transformers/title.ts',
      'src/charts/transformers/tooltip.ts',
      'src/charts/transformers/treemap.ts',
      'src/charts/transformers/visual-map.ts',
